...
fitname1 = '90percent_2param.mat';
fitname2 = '90percent_1param.mat';
for i = 1:iter
    ...
    imname = strcat('/scratch/gk925/hpc_brdf_fitting90/fit_results/multispectral/', fitname1);
    ...
    imname = strcat('/scratch/gk925/hpc_brdf_fitting90/fit_results/multispectral/', fitname2);
