...
function costIm = renderIm_1params(var)
...
writetable(T,'/scratch/gk925/hpc_brdf_fitting90/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_brdf_fitting90');
...
imPath = ['/scratch/gk925/hpc_brdf_fitting90/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
...
load('registered90.mat') % make this a variable
