...
clc;
clear all;
addpath(genpath('/share/apps/rendertoolbox3/2.1-18'));clc
addpath(genpath('/share/apps/psychtoolbox3/20150317'));
...
myFolder = fullfile('/scratch/gk925/hpc_brdf_fitting90');
...
myPBRT = '/share/apps/pbrt-v2-spectral/20150314/intel/bin/pbrt';
